...
class TestWebhook(unittest.TestCase):
    ...
    def test_webhookurldoesntstartcorrectly_sendserror(self) -> None:
        self.assertEqual("Please input a valid Discord Webhook.", 
                         Webhook(["https://discord.com/api/wesbooks/1089577542702333992/FDuO-Hdvasf_8sKyEoccZtcySYP97boXWubofaKL89GD4jd0IyM9jesU9t2ZzHCeDOWb"], requests=self.requests, mongo_client=None).message_to_send())
