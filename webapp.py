...
def upload_webhook():
    ...
    try:
        ...
        requests.post(webhook, json={"content": f"""Webhook Added! Use this URL to enter birthdays: {config('HOSTNAME')}?id={server_id}&webhook_set=true&discord_server_name={server_name}"""})
