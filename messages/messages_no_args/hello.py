...
class Hello(IMessage):
    ...
    """
    def __init__(self, server: Guild, params: List[str], requests: Requests = None, mongo_client: MockMongoClient = None) -> None:
        __doc__ = IMessage.__init__.__doc__
        super().__init__(server=server, message="hello", params=params, requests=requests, mongo_client=mongo_client)
